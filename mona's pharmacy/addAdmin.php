...
<!--------------------------------- Main section -------------------------------->
<section class="main" style="color:teal;"><h1> ALL ADMINS </h1>
  ...
  <table class="table" style="top:350px;font-size: 24px;">
    <thead>
      ...
      <tbody>
          <?php
          $counter =1;
          $result = $Users->viewSpecificUserType();
          while ($row = mysqli_fetch_array($result)){
              ...
              echo '<td>'.$row['page'].'</td>';
              echo '<td> <a href="deleteAdmin.php?uid='.$row['user_id'].'">Delete Admin </a> </td>';
...
<a href="addd.php?uid='.$row['user_id'].'" style="text-align:center;color:teal;"><h1>Add Admin</h1> </a>
